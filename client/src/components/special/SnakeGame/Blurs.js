...
const Blurs = () => {
  return (
    <div className={classes.blurs} alt="blur">
      <svg width="1112" height="1030" viewBox="0 0 1112 1030" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          ...
          <filter id="filter1_f_64_1234" x="0" y="0.827728" width="863.983" height="782.77" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="87" result="effect1_foregroundBlur_64_1234"/>
          </filter>
